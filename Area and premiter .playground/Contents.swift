...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        problem.text = "If the measurements of a rectangle is 6cm wide and 8m long. What is the area and the premiter?"
    ...
    @objc func answer() {
        area.text = "area = \(6 * 8) cm^2"
        premiter.text = "premiter = \((6 + 8) * 2) cm^2"
    }
